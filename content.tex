...
metadata. The subsequent editing process has been largely automatized using a
...
will be made for the final PDF only. However, both the PDF and the Zenodo entry
will contain all associated DOIs (data and code).
...
welcome and appreciated. The same holds for Open Office, Word or Pages, any
...
hackaton) in order to publish the results and enhance their
